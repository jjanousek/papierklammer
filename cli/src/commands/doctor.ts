...
export async function doctor(opts: {
  ...
  p.intro(pc.bgCyan(pc.black(" papierklammer doctor ")));
  ...
  try {
    ...
    const readResult: CheckResult = {
      ...
      canRepair: false,
      repairHint: "Run `papierklammer configure --section database` or `papierklammer onboard`",
    };
...
async function runRepairableCheck(input: {
  ...
  loadPapierklammerEnvFile(input.configPath);
