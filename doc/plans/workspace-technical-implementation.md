...
This repo already uses `PAPIERKLAMMER_DEPLOYMENT_MODE` for auth/deployment behavior (`local_trusted | authenticated`).
...
- `PAPIERKLAMMER_EXECUTION_TOPOLOGY=local|cloud|hybrid`
...
- use `PAPIERKLAMMER_EXECUTION_TOPOLOGY` as a defaulting guardrail
