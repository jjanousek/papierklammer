...
const manifest: PapierklammerPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current Papierklammer plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the Papierklammer domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
