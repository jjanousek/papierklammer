 ...
 * channel.
 *
 * The Papierklammer plugin runtime uses JSON-RPC 2.0 over stdio to communicate
...
export type { PluginLauncherRenderContextSnapshot } from "@papierklammer/shared";
 ...
 * we use strings (UUIDs or monotonic counters) for all Papierklammer messages.
 */
...
/**
 * Papierklammer plugin-specific error codes.
 *
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this Papierklammer instance. */
    instanceId: string;
    /** Semver version of the running Papierklammer host. */
    hostVersion: string;
  };
  /** Host API version. */
  apiVersion: number;
