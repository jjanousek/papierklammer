 ...
 *
 * These components are exported from `@papierklammer/plugin-sdk/ui` and are
 ...
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components In `@papierklammer/plugin-sdk/ui`
 */
...
function createSdkUiComponent<TProps>(name: string): React.ComponentType<TProps> {
  return function PapierklammerSdkUiComponent(props: TProps) {
