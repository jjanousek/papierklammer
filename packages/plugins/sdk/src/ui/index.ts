 ...
 *
 * The worker-side SDK is available from `@papierklammer/plugin-sdk` (root).
 *
 ...
 * import { usePluginData, usePluginAction } from "@papierklammer/plugin-sdk/ui";
 * import type { PluginWidgetProps } from "@papierklammer/plugin-sdk/ui";
 *
