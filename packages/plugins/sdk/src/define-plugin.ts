/**
 * `definePlugin` — the top-level helper for authoring a Papierklammer plugin.
 *
...
// ---------------------------------------------------------------------------
// PapierklammerPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface PapierklammerPlugin {
 ...
 * @returns A sealed `PapierklammerPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@papierklammer/plugin-sdk";
 ...
 * @see PLUGIN_SPEC.md §14.1 — Example SDK Shape
 */
export function definePlugin(definition: PluginDefinition): PapierklammerPlugin {
