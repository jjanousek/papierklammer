/**
 * Core types for the Papierklammer plugin worker-side SDK.
 *
 * These types define the stable public API surface that plugin workers import
 * from `@papierklammer/plugin-sdk`.  The host provides a concrete implementation
...
// ---------------------------------------------------------------------------
// Re-exports from @papierklammer/shared (plugin authors import from one place)
// ---------------------------------------------------------------------------
...
export interface ScopeKey {
  /** What kind of Papierklammer object this state is scoped to. */
...
export interface PluginEntityUpsert {
  ...
  externalId?: string;
  /** Human-readable title for display in the Papierklammer UI. */
  title?: string;
...
/**
 * `ctx.events` — subscribe to and emit Papierklammer domain events.
 *
...
export interface PluginEventsClient {
  /**
   * Subscribe to a core Papierklammer domain event or a plugin-namespaced event.
   *
 ...
 * This client resolves the reference through the Papierklammer secret provider
...
export interface PluginSecretsClient {
   ...
   * in the Papierklammer secret provider (e.g. `"MY_API_KEY"`).
   *
 ...
 * ```
 *
 * @see usePluginStream in `@papierklammer/plugin-sdk/ui`
 */
 ...
 * @example
 * ```ts
 * import { definePlugin } from "@papierklammer/plugin-sdk";
 *
