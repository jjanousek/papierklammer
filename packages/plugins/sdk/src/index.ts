 ...
 * import { definePlugin, runWorker, z } from "@papierklammer/plugin-sdk";
 *
...
// Manifest and constant types re-exported from @papierklammer/shared
 ...
 * @example
 * ```ts
 * import { z } from "@papierklammer/plugin-sdk";
 *
