...
import type { PluginCategory, PluginStatus, PapierklammerPluginManifestV1 } from "@papierklammer/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<PapierklammerPluginManifestV1>().notNull(),
