...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within PapierklammerPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the Papierklammer host.
 *
 ...
 */
export interface PapierklammerPluginManifestV1 {
   ...
   */
  minimumPapierklammerVersion?: PluginMinimumHostVersion;
