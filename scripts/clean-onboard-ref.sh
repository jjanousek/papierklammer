...
Environment overrides:
  ...
  PC_DATA=/tmp/data           Papierklammer data dir to use
  PAPIERKLAMMER_HOST=127.0.0.1    Host passed to the onboarded server
  PAPIERKLAMMER_PORT=3232         Port passed to the onboarded server
...
export PAPIERKLAMMER_HOST="${PAPIERKLAMMER_HOST:-127.0.0.1}"
export PAPIERKLAMMER_PORT="${PAPIERKLAMMER_PORT:-3100}"
export PAPIERKLAMMER_OPEN_ON_LISTEN="${PAPIERKLAMMER_OPEN_ON_LISTEN:-false}"
...
echo "PAPIERKLAMMER_HOST: $PAPIERKLAMMER_HOST"
echo "PAPIERKLAMMER_PORT: $PAPIERKLAMMER_PORT"
