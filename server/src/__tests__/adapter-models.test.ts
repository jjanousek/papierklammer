...
import { models as codexFallbackModels } from "@papierklammer/adapter-codex-local";
import { models as cursorFallbackModels } from "@papierklammer/adapter-cursor-local";
import { models as opencodeFallbackModels } from "@papierklammer/adapter-opencode-local";
import { resetOpenCodeModelsCacheForTests } from "@papierklammer/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.PAPIERKLAMMER_OPENCODE_COMMAND;
  ...
  it("returns opencode fallback models including gpt-5.4", async () => {
    process.env.PAPIERKLAMMER_OPENCODE_COMMAND = "__paperclip_missing_opencode_command__";
