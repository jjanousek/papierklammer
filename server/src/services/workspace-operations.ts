...
import { workspaceOperations } from "@papierklammer/db";
import type { WorkspaceOperation, WorkspaceOperationPhase, WorkspaceOperationStatus } from "@papierklammer/shared";
