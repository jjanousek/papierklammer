 ...
 * the Papierklammer service layer.
 *
...
export function pluginRegistryService(db: Db) {
  ...
  return {
     ...
     */
    install: async (input: InstallPlugin, manifest: PapierklammerPluginManifestV1) => {
    ...
    /**
     * Create or update a persistent mapping between a Papierklammer object and an
     * external entity.
     *
     * @param pluginId - The UUID of the plugin.
