...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@papierklammer/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: PapierklammerPluginManifestV1, pluginDbId?: string): void;
