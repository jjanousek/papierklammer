/**
 * PluginEventBus — typed in-process event bus for the Papierklammer plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@papierklammer/shared";
import type { PluginEvent, EventFilter } from "@papierklammer/plugin-sdk";
