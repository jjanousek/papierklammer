...
import { companySecrets, companySecretVersions } from "@papierklammer/db";
import type { AgentEnvConfig, EnvBinding, SecretProvider } from "@papierklammer/shared";
import { envBindingSchema } from "@papierklammer/shared";
