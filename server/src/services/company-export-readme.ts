 ...
 */
import type { CompanyPortabilityManifest } from "@papierklammer/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Papierklammer](https://paperclip.ing)");
  lines.push("");
