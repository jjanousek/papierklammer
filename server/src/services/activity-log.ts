...
import { activityLog } from "@papierklammer/db";
import { PLUGIN_EVENT_TYPES, type PluginEventType } from "@papierklammer/shared";
import type { PluginEvent } from "@papierklammer/plugin-sdk";
