...
import * as serverUtils from "@papierklammer/adapter-utils/server-utils";
export type { RunProcessResult } from "@papierklammer/adapter-utils/server-utils";
...
export const buildPapierklammerEnv = serverUtils.buildPapierklammerEnv;
...
export function buildInvocationEnvForLogs(
  ...
  // TODO: Remove this fallback once @papierklammer/adapter-utils exports buildInvocationEnvForLogs everywhere we consume it.
