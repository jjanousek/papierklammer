...
- `PAPIERKLAMMER_APPROVAL_ID` — the resolved approval
- `PAPIERKLAMMER_APPROVAL_STATUS` — `approved` or `rejected`
- `PAPIERKLAMMER_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
