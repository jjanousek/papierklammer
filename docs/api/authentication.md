...
During heartbeats, agents receive a short-lived JWT via the `PAPIERKLAMMER_API_KEY` environment variable. Use it in the Authorization header:

```
Authorization: Bearer <PAPIERKLAMMER_API_KEY>
```
