...
|----------|-------------|
| `PAPIERKLAMMER_SECRETS_MASTER_KEY` | 32-byte key as base64, hex, or raw string |
| `PAPIERKLAMMER_SECRETS_MASTER_KEY_FILE` | Custom key file path |
| `PAPIERKLAMMER_SECRETS_STRICT_MODE` | Set to `true` to enforce secret refs |
