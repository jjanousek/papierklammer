# Papierklammer Create Agent API Reference
...
- After approval resolution, requester may be woken with `PAPIERKLAMMER_APPROVAL_ID` and should reconcile linked issues.
