...
export function ScrollToBottom() {
  ...
  return (
    <button
      onClick={scroll}
      className="fixed bottom-[calc(1.5rem+5rem+env(safe-area-inset-bottom))] right-6 z-40 flex h-9 w-9 items-center justify-center border border-border bg-background shadow-md hover:opacity-80 md:bottom-6"
