...
import { buildAgentMentionHref, buildProjectMentionHref } from "@papierklammer/shared";
...
export const MarkdownEditor = forwardRef<MarkdownEditorRef, MarkdownEditorProps>(function MarkdownEditor({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative papierklammer-mdxeditor-scope",
    ...
    >
      <MDXEditor
        ...
        onBlur={() => onBlur?.()}
        className={cn("papierklammer-mdxeditor", !bordered && "papierklammer-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "papierklammer-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
