...
import { AGENT_ADAPTER_TYPES } from "@papierklammer/shared";
import type {
  Agent,
...
// Canonical type lives in @papierklammer/adapter-utils; re-exported here
// so existing imports from this file keep working.
export type { CreateConfigValues } from "@papierklammer/adapter-utils";
  ...
  return (
    <div className="space-y-1.5">
      ...
      <p className="text-[11px] text-muted-foreground/60">
        PAPIERKLAMMER_* variables are injected automatically at runtime.
      </p>
    </div>
  );
}
