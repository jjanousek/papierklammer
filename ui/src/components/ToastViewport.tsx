  ...
  return (
    ...
    >
      <div className="flex items-start gap-3 px-3 py-2.5">
        <span className={cn("mt-1 h-1.5 w-1.5 shrink-0 ", toneDotClasses[toast.tone])} />
        ...
        <button
          ...
          onClick={() => onDismiss(toast.id)}
          className="mt-0.5 shrink-0 rounded p-1 opacity-50 hover:opacity-80 hover:opacity-100 dark:hover:opacity-80"
        >
