                ...
                <div className="min-w-0">
                  ...
                  <div className="mt-2 flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
                    <Link
                      ...
                      className="inline-flex items-center border border-border/70 bg-background/70 px-2 py-1 font-mono hover:border-cyan-500/30 hover:text-foreground"
                    >
                      {run.id.slice(0, 8)}
                    </Link>
                ...
                <div className="flex items-center gap-2">
                  {isActive && (
                    <button
                      ...
                      className="inline-flex items-center gap-1 border border-red-500/20 bg-red-500/[0.06] px-2.5 py-1 text-[11px] font-medium text-red-700 hover:opacity-80 dark:text-red-300 disabled:opacity-50"
                    >
                  ...
                  <Link
                    to={`/agents/${run.agentId}/runs/${run.id}`}
                    className="inline-flex items-center gap-1 border border-border/70 bg-background/70 px-2.5 py-1 text-[11px] font-medium text-cyan-700 hover:border-cyan-500/30 hover:text-cyan-600 dark:text-cyan-300"
                  >
                    Open run
