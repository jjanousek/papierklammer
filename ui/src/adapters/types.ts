...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@papierklammer/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@papierklammer/adapter-utils").TranscriptEntry[];
