 ...
 *
 * Plugin bundles are built with `external: ["@papierklammer/plugin-sdk/ui", "react", "react-dom"]`,
 * so their ESM output contains bare specifier imports like:
 *
 * ```js
 * import { usePluginData } from "@papierklammer/plugin-sdk/ui";
 ...
 * - `import { ... } from "@papierklammer/plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"@papierklammer/plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@papierklammer/plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@papierklammer/plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@papierklammer/plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * of `@papierklammer/plugin-sdk/ui`, `react`, and `react-dom` resolve to the
