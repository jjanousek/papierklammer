...
import { AGENT_ROLES } from "@papierklammer/shared";
...
export function NewAgent() {
  ...
  const availableSkills = (companySkills ?? []).filter((skill) => !skill.key.startsWith("papierklammer/paperclip/"));
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Optional skills from the company library. Built-in Papierklammer runtime skills are added automatically.
              </p>
            </div>
