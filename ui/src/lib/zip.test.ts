...
describe("createZipArchive", () => {
  ...
  it("reads a Papierklammer zip archive back into rootPath and file contents", async () => {
    const archive = createZipArchive(
      {
        "COMPANY.md": "# Company\n",
        "agents/ceo/AGENTS.md": "# CEO\n",
  ...
  it("reads standard DEFLATE zip archives created outside Papierklammer", async () => {
