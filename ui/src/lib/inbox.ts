...
export const DISMISSED_KEY = "papierklammer:inbox:dismissed";
export const READ_ITEMS_KEY = "papierklammer:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "papierklammer:inbox:last-tab";
